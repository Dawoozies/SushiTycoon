...
namespace UnityEngine.AI
{
    #region Auto-Generated Content
        ...
        {
            None = 0,
            Walkable = 1, NotWalkable = 2, Jump = 4, Dock = 8, FishOnly = 16, CustomerOnly = 32, StaffOnly = 128, 
            All = ~0,
        }
        ...
        {
            Walkable = 0, NotWalkable = 1, Jump = 2, Dock = 3, FishOnly = 4, CustomerOnly = 5, StaffOnly = 7, 
        }
